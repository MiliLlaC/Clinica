...
import AgendarPorEspecialidad from './componentes/AgendarporEspecialidad'; // Importa AgendarPorEspecialidad
    ...
    <Router>
      <Routes>
        ...
        <Route path="/Dash" element={<Dashboard />}>
          ...
          <Route path="AgendarporEspecialidad" element={<AgendarPorEspecialidad />} />
